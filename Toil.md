...
- `reactive` - toil is work that appears as a reaction to various interrupts (e.g. firefighting, [[Public/Monitoring]] alarms), and is not strategy-driven
...
Reducing the amount of toil is a big part of [[Public/SRE]], as it helps the project in a few different ways:
- less toil leaves more time for engineering work ([[Public/Types of work in SRE]])
