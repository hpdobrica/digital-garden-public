...
When you try to reach `maps.google.com`, the process by which you get an actual IP address that corresponds to this domain is called [[Public/DNS Resolution]].
