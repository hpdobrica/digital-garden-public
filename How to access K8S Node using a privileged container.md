If you have a [[Public/K8S Pod]] with a privileged container running in [[Public/Kubernetes]] cluster, you can use it to gain access (like ssh) to the underlying [[Public/K8S Node]] it's running on by using `nsenter`.
