...
Axis-Aligned Bounding Box is one of the simplest collision detection methods in 2d, which only works on 2d rectangles that aren't rotated (their sides are parallel/perpendicular).
