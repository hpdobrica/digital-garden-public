...
Alternating is the subtlest form of spontaneous movements of attention, and is most often percieved like multitasking - we feel like we are paying attention to two different things at the same time, however this is an illusion. What happens instead is that our [[Attention]] is quickly alternating between multiple objects of attention, successively spending short, equal-ish periods of time on each of them. For example:
...
Holding a `conscious intention` to focus on the feeling of our breath, and returning to our breath whenever we realize that the focus was lost, communicates to the unconscious that keeping the focus on the breath is important.
